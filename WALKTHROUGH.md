...
- **Jira Project**: `TCVA` (Board: [https://sivaram311.atlassian.net/jira/software/c/projects/TCVA/boards/34](https://sivaram311.atlassian.net/jira/software/c/projects/TCVA/boards/34))
...
- **Edge Routing / DNS**: `https://telegram-media-dev.delena.buzz` (DEV port `3450`)
...
1. **User requests Vault UI**: Visits `https://telegram-media-dev.delena.buzz`.
...
Project Key: **`TCVA`** | Type: **Kanban** | URL: `https://sivaram311.atlassian.net/jira/software/c/projects/TCVA/boards/34`
