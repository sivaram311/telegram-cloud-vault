...
LOCAL_TEMP_DIR = Path(os.getenv("LOCAL_TEMP_DIR", "S:/staging"))
...
def offload_to_rclone(local_file_path: Path, remote_subpath: str) -> bool:
    """
    Directly moves local file from S: scratch to encrypted Google Drive.
    Guarantees local scratch purge upon transfer completion.
    """
